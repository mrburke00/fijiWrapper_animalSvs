...
data_dir="/scratch/Shares/layer/workspace/devin_sra/sv_step/sv_results/$animal/clean_data/"
ref_dir="/scratch/Shares/layer/workspace/devin_sra/sv_step/sv_results/$animal/ref"
bwa_errs="/scratch/Shares/layer/workspace/devin_sra/sv_step/align_src/bwa_errors"
sra_examples=("$@")
